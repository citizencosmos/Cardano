...
then  #
        ...
        sed --quiet 's/<PUBLC_ADDRESS>/'$PUBLC_ADDRESS'/g;s/<USERNAME>/'$USERNAME'/g;s/<NODE_ID>/'$1'/g' < ~/node$1/files/node-config-GENERIC-INFILE.yaml > ~/node$1/files/node-config$1.yaml
